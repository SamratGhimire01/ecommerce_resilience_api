...
@router.get('/average-duration',tags=["Visualizations"])
...
router
@router.get('/duration-report',tags=["Reports"])
...
@router.get('/content_distribution',tags=["Visualizations"])
...
@router.get('/report_content_distribution',tags=["Reports"])
...
@router.get('/yearly_trend',tags=["Visualizations"])
...
@router.get('/report_yearly_trend',tags=["Reports"])
...
@router.get('/top_countries',tags=["Visualizations"])
...
@router.get('/report_top_countries',tags=["Reports"])
...
@router.get('/rating_distribution',tags=["Visualizations"])
...
@router.get('/report_rating_distribution',tags=["Reports"])
